	...
	return (
		<div className="news-form flex flex-col gap-3">
			...
			<div className="flex flex-col gap-5">
				<input
					className="px-5 py-3 border-1 border-[#D0D0D0] rounded-lg text-[#2D2D2D] text-[18px] placeholder:text-[#2D2D2D]"
					type="email"
					name="userEmail"
					id="userEmail"
				...
				/>
				<button
					className="py-3 bg-[#3366FF] text-white rounded-lg shadow-md/40 transition active:shadow-transparent active:inset-shadow-sm/50 active:inset-shadow-[#23315b]"
